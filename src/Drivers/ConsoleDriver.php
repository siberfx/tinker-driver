...
namespace Siberfx\Tinker\Drivers;

use Siberfx\BotMan\Interfaces\DriverInterface;
use Siberfx\BotMan\Messages\Incoming\Answer;
use Siberfx\BotMan\Messages\Incoming\IncomingMessage;
use Siberfx\BotMan\Messages\Outgoing\OutgoingMessage;
use Siberfx\BotMan\Messages\Outgoing\Question;
use Siberfx\BotMan\Users\User;
...
class ConsoleDriver implements DriverInterface
{
    ...
    /**
     * @param string|\Siberfx\BotMan\Messages\Outgoing\Question $message
     * @param IncomingMessage $matchingMessage
